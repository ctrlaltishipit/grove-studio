-- ============================================================
-- Grove — 05_seed_demo.sql   ← THE DEMO FIXTURE. DO NOT SKIP THIS.
--
...
--
-- Run AFTER 01_schema.sql. Run it with RLS OFF (before stage S2) or from
-- the SQL editor, which uses the service role and bypasses RLS anyway.
--
-- HOW TO DEMO WITH IT
--   1. Run this file.
